...
<body id="home">  
   <header class="head">
     <div class="navbar top" id="navbar">
       <a href="#home"><h1 class="logo">
        <i class="fas fa-seedling"></i>
          <span class="text-primary"> Garbage</span> Out
       </h1>
       </a>
            ...
            <ul>
              ...
              <li><a href="system/login.php">Register Now</a></li>
              <li><a href="system/admin/index.php">Admin</a></li>
            </ul>
    ...
    <footer class="footer bg-dark">
      ...
      <p>Copyright &copy;, Gilmore Collins 2021</p>
      <p>Garbage out Initiative</p>
    </footer>
